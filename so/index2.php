...
$sql = "SELECT * FROM so_member WHERE Year(so_idpa_expire) > 2023 AND so_idpa_id is not null AND so_idpa_id <> '' AND so_status = 'enable' AND so_level = 'IPOC' ORDER BY so_firstname_en;";
$member_ipoc = $fnc->get_db_array($sql)[0];
$sql = "SELECT * FROM so_member WHERE Year(so_idpa_expire) > 2023 AND so_idpa_id is not null AND so_idpa_id <> '' AND  so_status = 'enable' AND so_level = 'CSO' ORDER BY so_firstname_en;";
$member_cso = $fnc->get_db_array($sql);
$sql = "SELECT * FROM so_member WHERE Year(so_idpa_expire) > 2023 AND so_idpa_id is not null AND so_idpa_id <> '' AND  so_status = 'enable' AND so_level = 'SO' ORDER BY so_firstname_en;";
// die ($sql . "<br><br>");
$member_so = $fnc->get_db_array($sql);
$sql = "SELECT * FROM so_member WHERE Year(so_idpa_expire) > 2023 AND so_idpa_id is not null AND so_idpa_id <> '' AND  so_status = 'enable' AND so_level <> 'IPOC' AND so_level <> 'CSO' AND so_level <> 'SO' ORDER BY so_firstname_en;";
        ...
        <div class="container">
            ...
            <div class="row justify-content-center">
                ...
                <?php foreach ($member_cso as $mem) { ?>
                    <div class="col-6 col-md-4 col-lg-3 mb-0 p-4">
