...
//     die('<div style="text-align: center; margin-top: 40vh;"><h1>ระบบปิดปรับปรุงชั่วคราว</h1><h3>< by admin ></h4></div>');
// }
                    ...
                    <div class="card bg-dark text-white box_shadow" style="border-radius: 1rem; background-color: #9b0000;">
                        ...
                        <div class="card-body px-5 py-2 text-center">
                            ...
                            <div class="mb-md-2 mt-md-4 pb-2">
                                ...
                                <?php } ?>
                                <form action="../sign/?act=signIn&p=admin" method="post">
                                    <h2 class="fw-bold mb-4 text-uppercase" style="letter-spacing: 0.25em;">SOTH Login</h2>
                                    <p class="text-white-50 mb-5 d-none">Please enter your login and password!</p>
                            ...
                            <div>
                                <p class="small mb-2 pb-lg-2 mt-3"><a class="text-white-50" href="forgot_pwd.php" target="_blank">ลืมรหัสผ่าน?</a> <a class="text-white-50" href="https://m.me/umnarj" target="_blank">ติดต่อแอดมิน</a></p>
    ...
    <script type="text/javascript" charset="UTF-8">
        document.addEventListener('DOMContentLoaded', function() {
            cookieconsent.run({
                ...
                "website_name": "idpasoth.com",
                "website_privacy_policy_url": "https://arch.mju.ac.th/policy/cookies"
            });
        });
    </script>
