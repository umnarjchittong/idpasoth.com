            ...
            <div class="collapse navbar-collapse" id="navbarCollapse">
                <ul class="navbar-nav me-auto mb-2 mb-md-0 text-capitalize">
                    <li class="nav-item">
                        <a class="nav-link<?php if (isset($_GET["v"]) && $_GET["v"] == "overall") {
                                                echo ' active"';
                                            } ?>" href="?v=overall&mid=<?= $_GET["mid"] ?>">Overall</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link<?php if (isset($_GET["v"]) && $_GET["v"] == "divisionclass") {
                                                echo ' active"';
                                            } ?>" href="?v=divisionclass&mid=<?= $_GET["mid"] ?>">Division/Class</a>
                    </li>
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu">
                            ...
                            foreach ($division as $div) {
                                ...
                                echo '" href="?v=stage&p=' . $div["score_stage_number"] . '&mid=' . $_GET["mid"] . '">Stage #' . $div["score_stage_number"] . '</a></li>';
                            }
                            ?>
                        </ul>
                    </li>
