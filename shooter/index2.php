...
<body class="d-flex flex-column h-100 bg-dark">
    <nav class="navbar navbar-expand-sm navbar-dark fixed-top bg-secondary bg-gradient">
    ...
    <main class="flex-shrink-0 mh-100">
        ...
        if ($view_result["setting_view_result"] == 'true') { ?>
            <div class="bg-dark text-secondary px-2 px-md-4 py-5 mx-auto text-start h-100" style="max-width: 700px; min-width: 300px">
                <?php if (isset($_GET["uid"]) && isset($_GET["act"]) && $_GET["act"] == "shooterview") {
                    ...
                    // echo '</pre>';
                ?>
                    <div class="mb-3 d-none" style="margin-top: 4em;">
                    ...
                    <div class="mb-3 d-flex justify-content-between" style="margin-top: 2em;">
                        <div style="min-width: 200px">
                            <img src="../images/soth_logo.png" style="width: 100%; max-width: 100px; min-width: 60px; margin-right: 1em;">
                            <p class="h4 fw-bold text-white mb-1"><?= $match["match_name"] ?></p>
                            <p class="h6 text-muted"><?= $match["match_location"] ?></p>
                        </div>
                        <div>
                            <img src="../img/ads_150.jpg" class="img-thumbnail" style="width: 100%; max-width: 150px; min-width: 100px">
                        </div>
                    </div>

                    <div class="mb-1">
                        <div class=""><span class="text-warning fw-bold h2 me-3"><?= $shooter["shooter_number"] ?></span><span class="text-capitalize h3 text-light"><?= $shooter["shooter_firstName"] . '&nbsp;&nbsp;' . $shooter["shooter_lastName"] ?></span></div>
                    ...
                    <div class="mt-2 d-flex justify-content-between">
                        <img src="../img/ads_350.jpg" class="img-thumbnail me-2" style="max-width: 350px; min-width: 140px">
                        <img src="../img/ads_350.jpg" class="img-thumbnail" style="max-width: 350px; min-width: 140px">
                    </div>
                ...
                <?php } else {
                    ...
                    $match = $fnc->get_db_row($sql);
                ?>
                    <div class="py-3 mt-2 col-12 col-md-8 col-lg-6 mx-auto h-100" style="max-width: 500px;">
                        <div><img src="../images/soth_banner.png" class="img-fluid box_shadow w-100"></div>
                        <div class="bg-info py-3 rounded-bottom shadow text-center h5 text-white"><?= $match["match_name"] ?></div>
                        ...
                        <form action="?" method="get">
                            <div class="input-group mb-3 my-4 w-100">
                                ...
                                <button class="btn btn-outline-info btn-lg px-4 fw-bold" type="submit">ดูผลการแข่งขัน</button>
        ...
        <footer class="footer mt-auto py-3 bg-light text-secondary px-4 text-center" style="position: relative; margin-top: -56px; height: 56px; clear: both; background-color: white;">
            <div class="container">
